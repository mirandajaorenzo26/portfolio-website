...
const MobileNav = ({ navRef, toggleNavBar, handleClick }) => {
  return (
    <nav
      ref={navRef}
      className='absolute right-0 top-0 z-50 min-h-screen min-w-[60vw] translate-x-[200%] border-none bg-white px-5 py-5 shadow-lg transition-all duration-500 dark:bg-navy-blue lg:hidden'>
      <button
