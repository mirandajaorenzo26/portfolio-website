...
export default function SchoolItem({ education }) {
  return (
    <div className='animate__animated animate__fadeInUp gap-5 rounded-xl bg-light-navy-blue p-5 text-center text-white  dark:bg-navy-blue dark:text-semi-white md:grid-cols-2'>
